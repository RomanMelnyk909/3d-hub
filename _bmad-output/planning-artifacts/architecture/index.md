...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Project Foundation](./starter-template-evaluation.md#project-foundation)
    - [Additional Packages Required](./starter-template-evaluation.md#additional-packages-required)
  ...
  - [Project Structure & Boundaries](./project-structure-boundaries.md)
    ...
    - [Environment Configuration](./project-structure-boundaries.md#environment-configuration)
